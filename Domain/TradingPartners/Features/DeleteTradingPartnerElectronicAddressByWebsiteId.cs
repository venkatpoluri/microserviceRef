...
public static class DeleteTradingPartnerElectronicAddressByWebsiteId
{
    public class DeleteTradingPartnerElectronicAddressByWebsiteIdQuery : IRequest<bool>
    {
                public Guid TradingPartnerId { get; set; }
        public Guid WebSiteId { get; set; }


        public DeleteTradingPartnerElectronicAddressByWebsiteIdQuery(Guid tradingPartnerId, Guid webSiteId)
        {
...
WebSiteId = webSiteId;
     ...
     public class Handler : IRequestHandler<DeleteTradingPartnerElectronicAddressByWebsiteIdQuery, bool>
    {
        ...
        public async Task<bool> Handle(DeleteTradingPartnerElectronicAddressByWebsiteIdQuery request, CancellationToken cancellationToken)
        {
