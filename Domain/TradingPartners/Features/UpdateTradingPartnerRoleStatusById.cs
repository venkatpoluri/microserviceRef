...
public static class UpdateTradingPartnerRoleStatusById
{
    public class UpdateTradingPartnerRoleStatusByIdQuery : IRequest<bool>
    {
...
public Statuses Statuses { get; set;}
        ...
        public UpdateTradingPartnerRoleStatusByIdQuery(Guid tradingPartnerId, Guid roleId, TradingPartnerManagement.Domain.TradingPartners.Dtos.Statuses statuses)
        {
...
Statuses = statuses;
     ...
     public class Handler : IRequestHandler<UpdateTradingPartnerRoleStatusByIdQuery, bool>
    {
        ...
        public async Task<bool> Handle(UpdateTradingPartnerRoleStatusByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            if (tradingPartnerQuery == null)
                throw new NotFoundException("TradingPartner");
                   ...
                   tradingPartnerQuery.TradingPartnerDocument.Roles.Remove(roles);
                    roles.Statuses =    roles.Statuses.Where(x => x.Id != request.Statuses.Id).ToList();
